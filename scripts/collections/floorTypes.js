...
module.exports = Backbone.Collection.extend({
    ...
    initialize: function (models, options) {
        ...
        this.listenTo(this.form, 'change:floorType', this.formChanged);
    },

    url: function () {
        return '/api/floorType/';
    },
    /**
    ...
    search : function(letters) {
        ...
        return new UM.Collections.FloorType(filter, this.options) ;
    }
});