...
module.exports = Backbone.Collection.extend({
    ...
    initialize: function (models, options) {
        ...
        this.listenTo(this.form, 'change:lowerSection', this.formChanged);
    },

    url: function () {
        return '/api/lowerSection/';
    },
    /**
    ...
    search : function(letters) {
        ...
        return new UM.Collections.LowerSection(filter, this.options) ;
    }
});