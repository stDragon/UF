...
module.exports = Backbone.Collection.extend({
    ...
    initialize: function (models, options) {
        ...
        this.listenTo(this.form, 'change:washingType', this.formChanged);
    },

    url: function () {
        return '/api/washingType/';
    },
    /**
    ...
    search : function(letters) {
        ...
        return new UM.Collections.WashingType(filter, this.options) ;
    }
});