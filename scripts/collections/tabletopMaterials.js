...
module.exports = Backbone.Collection.extend({
    model: UM.Models.TabletopMaterial,
    ...
    initialize: function (models, options) {
        ...
        this.listenTo(this.form, 'change:tabletopMaterial', this.formChanged);
    },

    url: function () {
        return '/api/tabletopMaterial/';
    },
    /**
    ...
    search : function(letters) {
        ...
        return new UM.Collections.TabletopMaterial(filter, this.options) ;
    }
});