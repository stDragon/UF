...
module.exports = Backbone.Collection.extend({
    ...
    initialize: function (models, options) {
        ...
        this.listenTo(this.form, 'change:lighting', this.formChanged);
    },
    ...
    search : function(letters) {
        ...
        return new UM.Collections.Lightings(filter, this.options) ;
    }
});