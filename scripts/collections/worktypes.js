...
module.exports = Backbone.Collection.extend({
    ...
    initialize: function (models, options) {
        ...
        this.listenTo(this.form, 'change:worktype', this.formChanged);
    },
    ...
    search : function(letters) {
        ...
        return new UM.Collections.Worktype(filter, this.options) ;
    }
});