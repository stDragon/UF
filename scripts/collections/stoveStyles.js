...
module.exports = Backbone.Collection.extend({
    ...
    initialize: function (models, options) {
        ...
        this.listenTo(this.form, 'change:stoveStyle', this.formChanged);
    },

    url: function () {
        return '/api/stoveStyle/';
    },
    /**
    ...
    search : function(letters) {
        ...
        return new UM.Collections.StoveStyle(filter, this.options) ;
    }
});