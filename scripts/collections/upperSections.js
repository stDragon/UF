...
module.exports = Backbone.Collection.extend({
    ...
    initialize: function (models, options) {
        ...
        this.listenTo(this.form, 'change:upperSection', this.formChanged);
    },

    url: function () {
        return '/api/upperSection/';
    },
    /**
    ...
    search : function(letters) {
        ...
        return new UM.Collections.UpperSection(filter, this.options) ;
    }
});